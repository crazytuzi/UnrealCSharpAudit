...
> ⚠️ **本表取代了旧版 INDEX 的两套互相矛盾的数字。** 旧版在此处给出 `P0=26`，并在另一处给出合计指向 749 与 829 的两组不同 P2/P3。上表由**机器解析 47 份报告正文**得到。
>
> 🔴 **统计口径（重新统计时务必注意）**：
...
| [09-问题清单/01-全局问题总表.md](09-问题清单/01-全局问题总表.md) | **全量 834 条**：编号 / 级别 / 复核结论 / 可达性 / 模块码 / 一句话问题 / 原文链接（**机器生成，不依赖人工誊抄**） |

> **口径说明**：全部数字以**机器解析 47 份报告正文**为准，取代旧版 INDEX 中两套互相矛盾的人工统计。
